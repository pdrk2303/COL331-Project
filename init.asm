...
main(void)
{
  ...
  68:	89 c3                	mov    %eax,%ebx
    printf(1, "pid=%d\n", pid);
  6a:	68 63 08 00 00       	push   $0x863
  6f:	6a 01                	push   $0x1
  71:	e8 6a 04 00 00       	call   4e0 <printf>
    if(pid < 0){
  ...
  b4:	50                   	push   %eax
  b5:	6a 00                	push   $0x0
  b7:	68 63 08 00 00       	push   $0x863
  bc:	6a 01                	push   $0x1
  be:	e8 1d 04 00 00       	call   4e0 <printf>
      exec("sh", argv);
  c3:	5a                   	pop    %edx
  c4:	59                   	pop    %ecx
  c5:	68 54 0b 00 00       	push   $0xb54
  ca:	68 7e 08 00 00       	push   $0x87e
  ...
  db:	6a 01                	push   $0x1
  dd:	e8 fe 03 00 00       	call   4e0 <printf>
      exit();
  ...
  e8:	6a 01                	push   $0x1
  ea:	6a 01                	push   $0x1
  ec:	68 48 08 00 00       	push   $0x848
  f1:	e8 c5 02 00 00       	call   3bb <mknod>
    open("console", O_RDWR);
  f6:	58                   	pop    %eax
  f7:	5a                   	pop    %edx
  f8:	6a 02                	push   $0x2
  fa:	68 48 08 00 00       	push   $0x848
...
printf(int fd, const char *fmt, ...)
{
 ...
 664:	eb 1a                	jmp    680 <printf+0x1a0>
          s = "(null)";
 666:	bb a0 08 00 00       	mov    $0x8a0,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6b5:	a1 5c 0b 00 00       	mov    0xb5c,%eax
{
 ...
 6d6:	73 10                	jae    6e8 <free+0x38>
{
 ...
 701:	5b                   	pop    %ebx
  freep = p;
 702:	a3 5c 0b 00 00       	mov    %eax,0xb5c
}
 707:	5e                   	pop    %esi
 708:	5f                   	pop    %edi
 709:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 74d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 750:	8b 3d 5c 0b 00 00    	mov    0xb5c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 799:	8b 3d 5c 0b 00 00    	mov    0xb5c,%edi
 ...
 7c2:	e8 e9 fe ff ff       	call   6b0 <free>
  return freep;
 7c7:	a1 5c 0b 00 00       	mov    0xb5c,%eax
 ...
 80e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 810:	c7 05 5c 0b 00 00 60 	movl   $0xb60,0xb5c
 817:	0b 00 00 
    base.s.size = 0;
 81a:	bf 60 0b 00 00       	mov    $0xb60,%edi
    base.s.ptr = freep = prevp = &base;
 81f:	c7 05 60 0b 00 00 60 	movl   $0xb60,0xb60
 826:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
